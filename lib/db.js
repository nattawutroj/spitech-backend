...
function updateproject(build, callback) {
    var command = `UPDATE public."Project" SET project_title_th='${build.project_title_th}', project_title_en='${build.project_title_en}', case_study_title_th='${build.project_study_title_th}', case_study_title_en='${build.project_study_title_en}' WHERE id_project = '${build.id_project}';`
    console.log(command)
    client.query(command, (err, result) => {
        console.log(err)
        if (typeof result == 'undefined') {
...
function projectinfomation(build, callback) {
    var command = `SELECT * FROM Public."Project" WHERE id_project = '${build.id_project}';`
    client.query(command, (err, result) => {
        console.log(err)
        if (typeof result == 'undefined') {
            callback(err)
...
function delsch(id_project, callback) {
